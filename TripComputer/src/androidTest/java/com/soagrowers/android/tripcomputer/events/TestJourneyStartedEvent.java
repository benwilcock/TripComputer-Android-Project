 ...
 */
public class TestJourneyStartedEvent extends TestCase {
    ...
    public void setUp() throws Exception {
        super.setUp();
        journey = new Journey();
        event = new JourneyStartedEvent(journey);
    }
    ...
    public void testEvent() throws Exception {
        ...
        assertSame(JourneyStatusEvent.Type.START_EVENT, event.getType());
    }
}
